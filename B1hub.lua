...
spawn(function()
    while true do game:GetService("RunService").RenderStepped:Wait()
        if Clip or _G.autoraid or _G.AutoFarmBone or _G.AutoFarmBon or _G.AutoHallowScythe or _G.FramBoss or _G.FarmLevel or _G.AutoNew or _G.AutoThird or _G.AutoSwan or _G.AutoSwanHop or _G.AutoPole or _G.AutoPoleHop or _G.AutoHakiRainbow or _G.AutoObservationHakiV2 or _G.AutoEliteHunter or _G.AutoEliteHunterHop or _G.AutoTushitaSword or _G.AutoTushitaSword or  _G.FramBoss or _G.AutoFarmAllBoss or _G.AutoCavender or _G.AutoCavenderHop or _G.Tween then
...
spawn(function()
    ...
    game:GetService("RunService").Stepped:Connect(function()
        ...
        kkii:Stop()
        if _G.FarmLevel or _G.Tween then
...
local ps = Tab2s:CreateSection('PointStats')
...
Tab1:CreateButton("OpenBountyFarm",function(d)
    loadbn()
end)
Tab1:CreateButton("BypassTp",function()
local p=game.Players.LocalPlayer;
local oldcframe;
local holdingfoil=false;
p.Character.Humanoid:SetStateEnabled(15,false);
...
game.Players.LocalPlayer.Character.Humanoid.Health = math.huge
if world1 then
TP(Vector3.new(5127.1284179688, 59.501365661621, 4105.4458007813),CFrame.new(5127.1284179688, 59.501365661621, 4105.4458007813))
for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame*CFrame.new(0,0,-5)
end
wait(1)
...
if world2 then
    TP(Vector3.new(-3281.6669921875, 239.4324798584, -10406.16796875),CFrame.new(-3281.66699, 239.43248, -10406.168, -0.061931286, -6.34393515e-08, 0.998080432, 8.85709195e-09, 1, 6.41109494e-08, -0.998080432, 1.28105633e-08, -0.061931286))
for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame*CFrame.new(0,0,-5)
end
wait(1)
...
if world3 then
    TP(Vector3.new(-742.041687, 205.204254, -11379.2129),CFrame.new(-742.041687, 205.204254, -11379.2129, -0.953330874, -1.21068569e-08, 0.301928073, 5.26685584e-09, 1, 5.67284388e-08, -0.301928073, 5.56711832e-08, -0.953330874))
for i, v in pairs(game.Workspace.Enemies:GetChildren()) do
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame*CFrame.new(0,0,-5)
end
wait(1)
...
if _G.LockMob == false then
    ...
    for k,x in pairs(game.Workspace.Enemies:GetChildren()) do
                if x.Name == Ms and x:FindFirstChild("HumanoidRootPart") and x:FindFirstChild("Humanoid") and x.Humanoid.Health > 0 and (x.HumanoidRootPart.Position-game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= magbring then
                    x.HumanoidRootPart.CanCollide = true
                    x.HumanoidRootPart.CFrame = PosMonAutoFarm
...
Tab1:CreateToggle("Fastattack[1]",true,function(d)
    _G.FastAttack1 = d
end)
...
Tab1:CreateButton("RedeemAllCode",function()
function UseCode(Text)
        game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer(Text)
    end
    UseCode("UPD16")
...
Tab1:CreateLabel("LockLevel")
Tab1:CreateLine()
_G.LockLevel = false
Tab1:CreateToggle("LockLevel",nil,function(value)
_G.LockLevel = value
...
Tab1:CreateSlider("SelectLeveLock",1,2200,1,function(v)
    _G.Levelclose = v
end)
...
ps:CreateSlider("PointStats",1,100,1,function(v)
    PointStats = v
end)
if world1 then
...
Tab33:CreateLabel("Abilities")
Tab33:CreateLine()

Tab33:CreateButton("SkyJump",function()
    
end)
Tab33:CreateButton("BusoHaki",function()
    
end)
Tab33:CreateButton("Soru",function()
    
end)
Tab33:CreateButton("KenHaki",function()
    
end)
Tab33:CreateToggle("AutoBuyAbilities",nil,function(t)
    Abilities = t
...
Tab33:CreateLabel("Refund")
Tab33:CreateLine()
Tab33:CreateButton("Refund Stat [2500 F]",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Refund","2")
end)
Tab33:CreateButton("Reroll Race[3000 F]",function()
...
Tab33:CreateLabel("Gun")
Tab33:CreateLine()
Tab33:CreateButton("Slingshot",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Slingshot")
end)
Tab33:CreateButton("Musket",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Musket")
end)
Tab33:CreateButton("Fintlock",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Flintlock")
end)
Tab33:CreateButton("Refined Flintlock",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Refined Flintlock")
end)
Tab33:CreateButton("Cannon",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyItem","Cannon")
end)
Tab33:CreateButton("Kabucha",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","1")
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","Slingshot","2")
end)
Tab33:CreateLabel("More")
Tab33:CreateLine()
--game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true
--game:GetService("Players").LocalPlayer.PlayerGui.Main.Inventory.Visible = true
--game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
--game:GetService("Players").LocalPlayer.PlayerGui.Main.AwakeningToggler.Visible = true
Tab33:CreateButton("OpenInventory",function()
game:GetService("Players").LocalPlayer.PlayerGui.Main.Inventory.Visible = true
end)
Tab33:CreateButton("OpenFruitInventory",function()
game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitInventory.Visible = true
end)
Tab33:CreateButton("OpenFruitShop",function()
game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
end)
Tab33:CreateButton("OpenAwakeningList",function()
game:GetService("Players").LocalPlayer.PlayerGui.Main.AwakeningToggler.Visible = true
end)

asd:CreateDropdown("AutoBuy DevilFruit",{
    "Bomb-Bomb",
    "Spike-Spike",
    "Chop-Chop",
    "Spring-Spring",
...
asd:CreateToggle("Buy Devil Fruit Sinper",nil,function(vu)
    BuyFruitSinper = vu
end)
spawn(function()
    while wait(.1) do
...
AuR:CreateToggle("Auto Raid", false, function(vu)
    _G.AutoRaid = vu
end)
AuR:CreateDropdown("Select Raid", {"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha"}, function(vu)
    _G.SelectRaid = vu
end)
AuR:CreateToggle("Auto Buy Microchip", false, function(vu)
    AutoBuychip = vu
end)
...
Misc:CreateButton("Rejoin Server",function(value)
    game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").localPlayer)
end)
Misc:CreateButton("Hop Server",function(value)
    local PlaceID = game.PlaceId
        local AllIDs = {}
        local foundAnything = ""
        local actualHour = os.date("!*t").hour
...
Misc:CreateButton("Hop Lower Server",function(value)
...
Misc:CreateButton("Join Pirates Team",function(value)
    local args = {
        [1] = "SetTeam",
        [2] = "Pirates"
    }
...
Misc:CreateButton("Join Marines Team",function(value)
    local args = {
        [1] = "SetTeam",
        [2] = "Marines"
    }
...
mi:CreateToggle("WalkOnWater",nil,function(vu)
    _G.Water = vu
end)
spawn(function()
    pcall(function()
...
Misc:CreateButton("BringFruit",function()
...
mi:CreateToggle("AutoBringFruit",nil,function(value)
...
mi:CreateToggle("FixGodModeBug",nil,function(f)
    _G.Fix = f
    if _G.Fix == true then
...
mi:CreateToggle("Dodge no Cooldown",nil,function(Value)
    nododgecool = Value
    NoDodgeCool()
end)
mi:CreateToggle("Inf Energy",nil,function(value)
    InfinitsEnergy = value
    originalstam = LocalPlayer.Character.Energy.Value
end)
Misc:CreateButton("Tp to Flower",function(value)
...
mi:CreateToggle("DeleteAttackFx",nil,function(Value)
...
Misc:CreateButton("Clone Your Self",function(value)
...
mi:Toggle("CloneCharacter",nil, function(vu)
    _G.ACloneCharacter = vu
if _G.ACloneCharacter == true then
while _G.ACloneCharacter do wait()
game.Players.LocalPlayer.Character.Archivable = true
game.Players.LocalPlayer.Character.Animate.Disabled = true
local clonec =  game.Players.LocalPlayer.Character:Clone()
clonec.Parent = workspace
